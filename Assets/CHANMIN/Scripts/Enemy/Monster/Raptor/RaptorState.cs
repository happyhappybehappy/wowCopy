...
namespace RaptorState
{
    public class BaseState : State<Raptor>
    {
        public override void Enter(Raptor Owner)
        {

        }
        public override void Update(Raptor Owner)
        {
        }
        public override void Exit(Raptor Owner)
        {
        }
    }
    ...
    public class TraceState : BaseState
    {
        ...
        public override void Exit(Raptor Onwer)
        { }
    }
