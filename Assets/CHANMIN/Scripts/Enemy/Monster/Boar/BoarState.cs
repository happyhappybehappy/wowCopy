...
namespace BoarState
{
    public class BaseState : State<Boar>
    {
        public override void Enter(Boar Owner)  { }
        public override void Update(Boar Owner) { }
        public override void Exit(Boar Owner)   { }
    }
    ...
    public class TraceState : BaseState
    {
        ...
        public override void Exit(Boar Onwer)
        {
